...
public class TransformDateFormat {
     ...
     * This constructor is used when creating a new instance of this class without
     ...
     * @return A string representing the date in the format "dd/MM/yyyy", or an
     ...
     * If the provided string is not in the correct format, a ParseException is
     * thrown.
     * 
     * @param dt The date string to be converted.
     * @return A Date object representing the date, or null if the string is not in
     *         the correct format.
    ...
    /**
     * Converts a Date object into a full date string in the format
     * "yyyy-MM-dd'T'HH:mm:ss'Z'".
     * If the provided date is null, an empty string is returned.
     * 
     * @param dt The Date object to be converted.
     * @return A string representing the date in the format
     *         "yyyy-MM-dd'T'HH:mm:ss'Z'", or an empty string if the date is null.
     * @author Cesar Bianchi
     * @since 1.0
     * 
     */
